    ...
    const formLayout = (locals) => {
      ...
      return (
        <div className="formWrap">
          <div>{locals.inputs.name1}</div>
          <div>{locals.inputs.bio1}</div>
          <div>{locals.inputs.city1}</div>
          <div>{locals.inputs.name2}</div>
          <div>{locals.inputs.bio2}</div>
          <div>{locals.inputs.city2}</div>
        </div>
      );
    };
