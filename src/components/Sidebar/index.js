  ...
  render() {
    return (
      <s.Sidebar>
        ...
        <br />
        <br />
        <Link className="sidebar_link" to={'/game'}>
          Tic tac toe
        </Link>
        <br />
        <br />
        <Link className="sidebar_link" to={'/todo'}>
          Todo
        </Link>
        <br />
        <br />
        ...
        <br />
        <br />
        <Link className="sidebar_link" to={'/settings/multiselect'}>
          Settings Multiselect
        </Link>
        <br />
        <br />
        <Link className="sidebar_link" to={'/settings/dummy'}>
          Settings Dummy
        </Link>
        <br />
        <br />
